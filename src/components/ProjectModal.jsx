    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl max-h-[90vh] glass-card rounded-sm shadow-2xl overflow-y-auto z-10 flex flex-col border-[#C8A45D]/30 grain-texture"
        >
          {/* Header Banner */}
          ...
          <div className="p-6 sm:p-10 space-y-10">
            ...
            <div className="relative rounded-sm overflow-hidden premium-image-frame max-h-[350px]">
              <img
                src={project.image}
                alt={project.title}
                className="w-full h-full object-cover brightness-90 contrast-105"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0D0D0D] via-transparent to-transparent opacity-50 pointer-events-none" />
            </div>

            {/* Key Meta Grid */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-5 glass-surface rounded-sm text-xs">
              <div>
            ...
            {/* Business Problem */}
            <div className="space-y-3 p-6 glass-surface border-l-2 border-[#C8A45D] rounded-r-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-6 glass-surface rounded-sm space-y-3">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                {project.details.results.map((res, idx) => (
                  <li key={idx} className="flex items-start gap-3 p-3 glass-surface rounded-sm text-sm text-[#F2F0EA]">
            ...
            {/* Key Learnings */}
            <div className="p-6 glass-surface border border-[#C8A45D]/30 rounded-sm space-y-2">
              <h4 className="text-xs tracking-widest text-[#C8A45D] font-semibold uppercase flex items-center gap-2">
          ...
          {/* Footer Close Button */}
          <div className="p-6 glass-nav border-t border-white/[0.06] flex justify-end">
            <button
              onClick={onClose}
